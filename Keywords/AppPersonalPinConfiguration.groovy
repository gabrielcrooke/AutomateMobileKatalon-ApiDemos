...
class AppPersonalPinConfiguration {
	...
	public static void PinConfiguration() {
		...
		MobileBuiltInKeywords.sendKeys(findTestObject('Object Repository/AppPersonalEnrolamiento/android.widget.PinConf4'), '1')
		MobileBuiltInKeywords.sendKeys(findTestObject('Object Repository/AppPersonalEnrolamiento/android.widget.PinConf5'), '1')
